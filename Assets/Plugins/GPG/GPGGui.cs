...
public class GPGGui : MonoBehaviour {
	...
	private string testLeaderBoard = "CgkI7PWMhvoCEAIQAg";
	private string testAchievement = "CgkI7PWMhvoCEAIQAQ";
	private string testIncAchievement = "CgkI7PWMhvoCEAIQDA";
    private int testIncACTotalSteps = 10;

    double currACPercent = 2;
